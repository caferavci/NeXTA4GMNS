	...
	: CBaseDialog(CDlgMOE::IDD, pParent)
{
  ...
  void GetMaxLabelLength();
   ...
   COLORREF itsBackgroundColor;
	...
	void DrawAgentTrajectory(eLinkMOEMode MOEType , CPaintDC* pDC, CRect PlotRect, bool LinkTextFlag);
...
public:
	...
	afx_msg void OnMoeNumberofqueuedAgents();
	afx_msg void OnMoeNumberofqueuedAgents33788();
};
