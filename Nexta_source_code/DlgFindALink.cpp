...
extern int read_2_integers_from_a_string(CString str, long &value1, long &value2);
...
BOOL CDlgFindALink::OnInitDialog()
{
	...
	m_FindObjectList.AddString("Link: LinkID");
...
void CDlgFindALink::OnBnClickedFindAgent()
{
	UpdateData(true);
	m_SearchMode = efind_Agent;
	OnOK();
